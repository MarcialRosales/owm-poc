...
CREATE OR REPLACE VIEW CIVIL_NETWORK_VIEW AS
SELECT N1.LABEL, N.NODE1, N2.LABEL, N.NODE2, S.LABEL, N.LINK
FROM CIVIL_NETWORK N
  LEFT JOIN STRUCTURE_VIEW N1 ON N.NODE1 = N1.ID
  LEFT JOIN STRUCTURE_VIEW N2 ON N.NODE2 = N2.ID
  LEFT JOIN SPAN_VIEW S ON N.LINK = S.ID;
